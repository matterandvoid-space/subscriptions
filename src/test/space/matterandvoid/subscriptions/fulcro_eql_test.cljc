  ...
  (testing "to-many union queries"
    (is (=
          #:list{:items   [#:todo{:id     2, :text "todo 2",
                                  :author #:user{:id      2, :name "user 2",
                                                 :friends [#:user{:id 2, :name "user 2", :friends [[:user/id 2] [:user/id 1] [:user/id 3]]}
                                                           #:user{:id 1, :name "user 1", :friends [#:user{:id 2, :name "user 2", :friends [[:user/id 2] [:user/id 1] [:user/id 3]]}]}
                                                           #:user{:id 3, :name "user 3", :friends [#:user{:id 2, :name "user 2", :friends [[:user/id 2] [:user/id 1] [:user/id 3]]}
                                                                                                   #:user{:id 4, :name "user 4", :friends [#:user{:id 3, :name "user 3", :friends [[:user/id 2] [:user/id 4]]}
                                                                                                                                           #:user{:id 4, :name "user 4", :friends [[:user/id 3] [:user/id 4]]}]}]}]}}
...
(deftest recursive-join-queries
  ...
  (testing "handles self-cycle"
    ...
    (testing "handles finite self-recursive (to-one) cycles"
      (is (= #:human{:id 1, :best-friend #:human{:id 1, :best-friend [:human/id 1], :name "human Y"}, :name "human Y"}
    ...
    (is (=
          #:user{:name    "user 1", :id 1,
                 :friends [#:user{:name    "user 2", :id 2,
                                  :friends [#:user{:name "user 2", :id 2, :friends [[:user/id 2] [:user/id 1] [:user/id 3]]}
                                            #:user{:name "user 1", :id 1, :friends [[:user/id 2]]}
                                            #:user{:name    "user 3", :id 3,
                                                   :friends [#:user{:name "user 2", :id 2, :friends [[:user/id 2] [:user/id 1] [:user/id 3]]}
                                                             #:user{:name    "user 4", :id 4,
                                                                    :friends [#:user{:name "user 3", :id 3, :friends [[:user/id 2] [:user/id 4]]}
                                                                              #:user{:name "user 4", :id 4, :friends [[:user/id 3] [:user/id 4]]}]}]}]}]}
          (<sub app [::user {:user/id 1 sut/query-key [:user/name :user/id {:user/friends '...}]}])))))
